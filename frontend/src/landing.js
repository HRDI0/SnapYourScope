...
const I18N = {
  en: {
    ...
    li2: 'Rank tracking with selected sources/engines',
    li3: 'Prompt tracking demo with usage cap',
    li4: 'Features and limits may change; severe issues should be reported via Inquiry.',
    ...
    feature3Title: 'Search Rank Tracker',
  ...
  ko: {
    ...
    li2: '선택된 소스/엔진 기반 순위 추적',
    li3: '사용량 제한이 있는 프롬프트 추적 데모',
    li4: '기능/정책은 변동될 수 있으며 심각한 오류는 문의 탭으로 제보해주세요.',
  ...
  ja: {
    ...
    li2: '選択ソース/エンジンでの順位追跡',
    li3: '利用上限付きプロンプト追跡デモ',
    li4: '機能と制限は変更される場合があります。重大な不具合は Inquiry からご連絡ください。',
